...
(Previously: Free and Pro existed with unspecified feature gates.)
...
(Previously: new users received a 30-day Pro trial with only generic expiry behavior.)
...
(Previously: UI only showed current tier and trial state.)
