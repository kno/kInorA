...
(Previously: platform scope was unstated; now explicitly web + mobile.)
...
(Previously: stated "synced once and marked as synchronized" without idempotency or conflict-resolution rules.)
...
(Previously: listed date/duration/exercises/volume/avg RPE without stating sync independence.)
