...
(Previously: The system stored eligible conversation context as embeddings.)
...
(Previously: The AI flow continued only when no vector memories existed.)
...
(Previously: Vector search filtered by tenant id and user id.)
