# Delta for 14b-v1.1-adaptation-rpe-feedback
...
(Previously: SHOULD-level requirement anchored a vague 6-8 zone over 8 sessions with no window/sample-floor/ladder semantics.)
...
(Previously: "Feedback Integration" required the system to MUST collect qualitative feedback values and use them to shape the next generated block — that requirement is narrowed out of this slice.)
