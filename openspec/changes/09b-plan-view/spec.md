...
SC-10: /plan page — user has a generating plan → renders PlanStatusView with status="generating"; spinner and generating message visible
SC-11: /plan page — user has a failed plan → renders PlanStatusView with status="failed"; error message and link to /plan/[id] for regeneration visible
