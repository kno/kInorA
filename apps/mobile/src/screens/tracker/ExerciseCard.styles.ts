...
export const styles = StyleSheet.create({
  ...
  stepSizeOptions: { flexDirection: "row", gap: spacing[1] },
  stepSizeOption: {
    flex: 1,
    height: 40,
    alignItems: "center",
  ...
  stepSizeOptionTextActive: { color: colors.accent },
  rpeField: { marginBottom: 20 },
  rpeLabel: {
    fontSize: 11,
    letterSpacing: 1.6,
    textTransform: "uppercase",
